...
interface PricingTiersPreConstructionProps {
    fullAddress: string;
}
              ...
              {tiers.map((tier) => (
                ...
                >
                  ...
                  <a
                    ...
                    ${tier.name === 'Go Big & Go Gig Fiber' ? 'bg-primary hover:secondary' : 'bg-secondary'}`}
                  >
                    Pre-Order
                  </a>
                </div>
...
export default PricingTiersPreConstruction;
